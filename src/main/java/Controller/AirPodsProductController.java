    ...
    public void initialize(){
        ...
        if (circleNero != null) {
            ...
            circleNero.setOnMouseClicked(e -> {
                ...
                coloreLabel.setText("Colore: Mezzanotte");
                immagineProdotto.setImage(immagineMax2);
            });

            circleBianco.setOnMouseClicked(e -> {
                coloreMax2 = "Baige";
                immagineMax2 = loadImage("/it/uid/unitech/Images/AirPods Max 2 Bianche.png");
                coloreLabel.setText("Colore: Baige");
                immagineProdotto.setImage(immagineMax2);
            });
            ...
            circleBlu.setOnMouseClicked(e -> {
                ...
                coloreLabel.setText("Colore: Azzurro");
                immagineProdotto.setImage(immagineMax2);
            });
            ...
            circleArancione.setOnMouseClicked(e -> {
                ...
                coloreLabel.setText("Colore: Arancione");
                immagineProdotto.setImage(immagineMax2);
            });
        ...
        if (circleBianco3 != null) {
            ...
            circleBianco3.setOnMouseClicked(e -> {
                ...
                coloreLabel3.setText("Colore: Bianco");
                immagineProdotto3.setImage(immaginePro3);
            });
        ...
        if (circleBianco4 != null) {
            ...
            circleBianco4.setOnMouseClicked(e -> {
                ...
                coloreLabel4.setText("Colore: Bianco");
                immagineProdotto4.setImage(immagine4);
            });
